						...
						<div class="top-left">
							<ul class="list-main">
								...
								<li><i class="ti-email"></i>
									<a href="mailto:contact@trazishop.com">contact@trazishop.com</a></li>
							</ul>
						</div>
						<!--/ End Top Left -->
					</div>
					...
					<div class="col-lg-8 col-md-7 col-12">
						<div class="search-bar-top">
							<div class="search-bar">
								<marquee><h4> Portrait du marché </h4></marquee>
							</div>
						</div>
					</div>
					...
					<div class="col-12">
						<div class="product-info">
							...
							<div class="tab-content" id="myTabContent" style="background: #F9F9F9; padding-left:25px; text-align: center;">
								<!-- Start Single Tab -->
								<div class="tab-pane fade <?= @$show_e; //show active ?>" id="man" role="tabpanel">
							<hr>
								<!-- Start recherche  -->
							...
							<hr>
								...
								<!--/ End Single Tab -->
								<!-- Start Single Tab -->
								<div class="tab-pane fade <?= @$show_o; //show active ?>" id="women" role="tabpanel">
									<hr>
									<!-- Start recherche  -->
								    <section class="shop-newsletter section" style="margin:0 30px 0 0; padding:0;">
								        <div class="container">
								...
								<!--/ End Single Tab -->
								<!-- Start Single Tab -->
								<div class="tab-pane fade <?= @$show_eg; //show active ?>" id="kids" role="tabpanel">
									<hr>
									<!-- Start recherche  -->
								    <section class="shop-newsletter section" style="margin:0 30px 0 0; padding:0;">
								        <div class="container">
								...
								<!--/ End Single Tab -->
								<!-- Start Single Tab -->
								<div class="tab-pane fade <?= @$show_ec; //show active ?>" id="accessories" role="tabpanel">
									<hr>
								<!-- Start recherche  -->
								    <section class="shop-newsletter section" style="margin:0 30px 0 0; padding:0;">
								        <div class="container">
								...
								<!--/ End Single Tab -->
								<!-- Start Single Tab -->
								<div class="tab-pane fade <?= @$show_u; //show active ?>" id="essential" role="tabpanel">
									<hr>
								<!-- Start recherche  -->
								    <section class="shop-newsletter section" style="margin:0 30px 0 0; padding:0;">
								        <div class="container">
								...
								<!--/ End Single Tab -->
								<!-- Start Single Tab -->
								<div class="tab-pane fade <?= @$show_sp; //show active ?>" id="prices" role="tabpanel">
									<hr>
								<!-- Start recherche  -->
								    <section class="shop-newsletter section" style="margin:0 30px 0 0; padding:0;">
								        <div class="container">
